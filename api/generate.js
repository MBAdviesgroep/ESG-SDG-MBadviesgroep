...

{
  ...
  "maatregelen": [
    {
      ...
      "co2": 0.0,
      "tvt": 0.0,
      "subs": "BEREKEN subsidie voor déze specifieke maatregel. Warmtepomp: 30% van capex (max €5.000). Isolatie: €30/m² via SVOH/SEEH. HR-glas: €40-80/m². Zonnepanelen: €0. EIA-voordeel: ca. 10% van capex voor zakelijk. Geef geheel getal, 0 als geen subsidie van toepassing.",
      "label": "+0",
  ...
  "co2_pad": "BEREKEN: array van 16 getallen (Y0 t/m Y15) die het verwachte CO₂-reductiepad tonen in ton/jr. Start bij totale huidige uitstoot, daalt geleidelijk na uitvoering maatregelen naar einddoel. Gebruik scope_voor.tot als startpunt.",
  "cashflow": "BEREKEN: array van 16 getallen (Y0 t/m Y15) die de cumulatieve cashflow tonen in €. Y0 = -(capex_totaal - capex_subsidie - capex_eigen). Elke jaar + bes_jaar. Verwerk rentekorting in jaar 1-15. Geef getallen terug, geen strings.",
  "scope_voor": "BEREKEN op basis van energiedata uit het rapport: {s1: scope1 in tCO₂ (gas), s2: scope2 in tCO₂ (elektra), tot: s1+s2}",
  "scope_na": "BEREKEN na uitvoering maatregelen: {s1: scope1 na (gas daalt door warmtepomp/isolatie), s2: scope2 na (elektra daalt, maar opwek stijgt), tot: s1+s2}",

  "label_pad": ["G","F","E","D","C","B","A","A+","A++","A+++","A++++"],
  "label_huidig_idx": "BEREKEN: index van huidig_label in label_pad (G=0, F=1, E=2, D=3, C=4, B=5, A=6, A+=7, A++=8, A+++=9, A++++=10)",
  "label_streef_idx": "BEREKEN: index van streef_label in label_pad",
  "primaire_energie_reductie_pct": "BEREKEN op basis van energielabel en maatregelen uit rapport — geheel getal",
  "co2_reductie_ton": "BEREKEN: totale jaarlijkse CO₂-reductie in ton (scope_voor.tot - scope_na.tot) — één decimaal",
  "bes_jaar": "BEREKEN: totale jaarlijkse energiekostenbesparing in € op basis van maatregelen uit rapport — geheel getal",
  "capex_totaal": "EXTRAHEER uit rapport: totale investering alle maatregelen in € — geheel getal",
  "capex_subsidie": "BEREKEN op basis van maatregelen uit het rapport. Gebruik deze regels: warmtepomp (hybride) = 30% van aanschafprijs (max €5.000 ISDE). Zonnepanelen = geen subsidie (saldering). Dakisolatie/vloerisolatie/gevelisolatie via SVOH of SEEH: €30/m² (schat m² op basis van oppervlakte pand). HR-glas = €40-80 per m² (schat). EIA = 40% fiscale aftrek over belastbare winst = ca. 10% netto voordeel op totale investering voor zakelijke eigenaren. Tel alle subsidies op. Minimaal 10% van capex_totaal, maximaal 35%. Geef geheel getal.",
  "capex_lening": "BEREKEN: 70% van (capex_totaal - capex_subsidie). Dit is het standaard green-loan bedrag. Minimaal 60%, maximaal 80% van netto investering. Geef geheel getal.",
  "capex_eigen": "BEREKEN: capex_totaal - capex_subsidie - capex_lening. Geef geheel getal.",
  "rente_referentie": "GEBRUIK: '5,15% → 4,90%' als standaard — tenzij rapport andere rente vermeldt",
  "rentekorting_bps": 25,
  "looptijd_jr": 15,
